...
templates_path = ['.']
extlinks = {
    'issue': ('https://github.com/garbled1/dvd_renamer/issues/%s', '#'),  # noqa: E501
    'pr': ('https://github.com/garbled1/dvd_renamer/pull/%s', 'PR #'),  # noqa: E501
    }
...
linkcheck_ignore = [
    r'https://codecov.io/gh/garbled1/dvd_renamer/*',
    ]

html_theme = "sphinx_py3doc_enhanced_theme"
html_theme_path = [sphinx_py3doc_enhanced_theme.get_html_theme_path()]
html_theme_options = {
    'githuburl': 'https://github.com/garbled1/dvd_renamer',
    }
